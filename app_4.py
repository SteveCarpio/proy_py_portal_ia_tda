# ==========================================
# 🧠 LocalDocChat - RAG con Memoria y Ollama (Moderno)
# ==========================================
# Autor: ChatGPT
# Descripción: Chat con PDFs usando RAG + Ollama + Streamlit
# Compatible con LangChain 1.0+, Streamlit 1.38+, Ollama actualizado
# ==========================================
...
# ⚠️ Ollama moderno para evitar DeprecationWarning
...
DATA_PATH = "data"             # Carpeta para guardar PDFs
...
def process_and_index_pdf(file_path):
    ...
    genera embeddings con Ollama y los indexa en Chroma.
    """
